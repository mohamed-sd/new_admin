...
if (isset($_GET['id'])) {
    $id = intval($_GET['id']);
    $sql = "SELECT * FROM tipper WHERE id = $id";
...
<head>
  <meta charset="UTF-8">
  <title>📝 تقرير القلاب - <?php echo $row['machine_name']; ?></title>
...
<div class="main full" id="main">
  ...
  <h2>📝 تقرير تفصيلي لساعات عمل القلاب</h2>
  ...
  <table class="info-table">
    ...
    <tr><th>الإضافي</th><td><?php echo $row['extra_hours_total']; ?></td></tr>
    ...
    <tr><th>عدد المشاوير</th><td><?php echo $row['number_of_moves']; ?></td></tr>
    <tr><th>ملاحظات العمل</th><td><?php echo nl2br($row['work_notes']); ?></td></tr>
  </table>
  ...
  <table class="info-table">
    ...
    <tr><th>ملاحظات</th><td><?php echo nl2br($row['fault_notes']); ?></td></tr>
  ...
  <table class="info-table">
    ...
    <tr><th>ملاحظات المشغل</th><td><?php echo nl2br($row['operator_notes']); ?></td></tr>
  </table>
